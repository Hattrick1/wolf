...
client.on("message", message => {
 ...
 if (message.content === "^^help") {
  ...
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .addField("『Wolf Bot』 『اسم البوت』", true)
      
      .addField("『@нαττяɪcĸ#8910』『مصمم البوت』", true)
...
القسم الثالث مصمم البوت | @нαττяɪcĸ#8910 
...
if (message.content === '^^support') {
      message.author.send(' |https://discord.gg/gZmsctp| لـ أي استفسار').catch(e => console.log(e.stack));
...
if (message.content === '^^invite') {
      message.author.send(' رابط البوت |  https://discordapp.com/oauth2/authorize?client_id=454713551471378443&scope=bot&permissions=2146958591 ').catch(e => console.log(e.stack));
...
.setFooter("-")  
  ...
  client.login("NDU0NzEzNTUxNDcxMzc4NDQz.DfyjVQ.FLE-tFTK70jRiFNiItzBpXoQsWQ")